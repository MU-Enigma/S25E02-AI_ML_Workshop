# -*- coding: utf-8 -*-
"""AI_ML_workshop code.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1mBEeuv6yb4YFN8_PoUqxPl1gAcTkuh67
"""
...
Settings.llm = None
Settings.chunk_size = 256 #RAG breaks down the data into chunks before starting
Settings.chunk_overlap = 25
#chunk overlap helps preserve information at the chunk boundaries
#Larger chunk overlap means more chunks sharing common characters.

pdf_loader = PyMuPDFReader()
pages = pdf_loader.load_data("/content/Data/File/Work.pdf")
...
query = "What is the formula for Work?"
...
comment = "What is the formula for Work?" #Replace with the same question as used in query above
