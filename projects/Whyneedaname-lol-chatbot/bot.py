...
pages = pdf_loader.load_data("/content/BotGenesis/Lect2-06web.pdf")
...
query = "What is monotone function?"
response = query_engine.query(query)

query=input("Don't ask question ")
response= query_engine.query(query)
context = "Context: \n"
...
comment = "Who am i?" #Replace with the same question as used in query above
